...
import cn.wangslip.bean.*;
import cn.wangslip.handler.GraphHandler;
import cn.wangslip.service.DataService;
...
//    }
    ...
    @GetMapping("/testpath")
    @ResponseBody
    public String testpath(HttpSession session) {
        String filePath = session.getServletContext().getRealPath("echarts");
